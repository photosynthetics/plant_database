...
class _PlantModel extends PlantModel {
  const _PlantModel({this.latinName = '', required this.commonName, this.family = '', required this.type, required this.description, required final  List<Stage> stages}): _stages = stages,super._();
  factory _PlantModel.fromJson(Map<String, dynamic> json) => _$PlantModelFromJson(json);

@override@JsonKey() final  String latinName;
